    ...
    <View style={{ flex: 1, backgroundColor: palette.bg, alignItems: "center", justifyContent: "center", paddingHorizontal: 34 }}>
      <View style={{ width: 150, height: 150, marginBottom: 22 }}>
        <Svg width={150} height={150} viewBox="0 0 150 150">
          <Circle cx={75} cy={75} r={R} fill="none" stroke="#E6E9EF" strokeWidth={11} />
      ...
      <View style={{ width: "100%", marginTop: 22, gap: 8 }}>
        {[
          ...
          <View key={r.path} style={{ backgroundColor: palette.card, borderRadius: 12, paddingHorizontal: 13, paddingVertical: 11, flexDirection: "row", alignItems: "center", gap: 10, shadowColor: "#141928", shadowOpacity: 0.05, shadowRadius: 3, shadowOffset: { width: 0, height: 1 }, elevation: 1 }}>
